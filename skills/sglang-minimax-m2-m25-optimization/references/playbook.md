# MiniMax M2/M2.5/M2.7 Optimization Playbook
...
rg -n "MiniMax|minimax|M2.7|m27|minimax-append-think|minimax-m2" docs docs_new test/registered python/sglang/srt .github/workflows
```
...
As of SGLang `origin/main` commit `2cf3ac515` on `2026-04-21`, several MiniMax-M2.5 optimization PRs that were previously active are now part of `main`, but not every important gap is closed.
