...
- [#23474](https://github.com/sgl-project/sglang/pull/23474): CPU offload for hybrid linear-attention models.
- Watch Qwen3-Next open PRs for Mamba scheduler, MTP, and GDN fixes.
- Watch Qwen VLM open PRs for multimodal encoder behavior.
